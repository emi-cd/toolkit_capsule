...
parentpath = '../data/' #"Directory path with parent dir before xml_dir or img_dir"
addxmlpath = parentpath + 'train_tile' #"Directory path with XML files"
addimgpath = parentpath + 'train_tile' #"Directory path with IMG files"
outputpath = parentpath + 'train_tile' #"output folder for yolo format"
classes_txt = '/Users/emi/workspace/work/ubuntu/darknet/task_capsule/capsule.names' #"File containing classes"
